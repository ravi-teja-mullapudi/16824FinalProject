...
data_listfile = '/home/rmullapu/16824FinalProject/superclass_labels_val.txt'
...
net_list.append(caffe.Net('/home/rmullapu/16824FinalProject/models/compute_increase/2_unit_deploy.prototxt',
                 '/home/rmullapu/16824FinalProject/2_unit/_iter_30000.caffemodel', caffe.TEST))
...
net_list.append(caffe.Net('/home/rmullapu/16824FinalProject/models/compute_increase/1_unit_deploy.prototxt',
                 '/home/rmullapu/16824FinalProject/1_unit/_iter_40000.caffemodel', caffe.TEST))
...
net_list.append(caffe.Net('/home/rmullapu/16824FinalProject/models/bvlc_reference_caffenet/deploy.prototxt',
                 '/home/rmullapu/16824FinalProject/alex_net/_iter_50000.caffemodel', caffe.TEST))
net_names.append('alex_net')

net_list.append(caffe.Net('/home/rmullapu/16824FinalProject/models/vgg/vgg_deploy.prototxt',
                 '/home/rmullapu/16824FinalProject/vgg/_iter_20000.caffemodel', caffe.TEST))
net_names.append('vgg')

meta_net = caffe.Net('/home/rmullapu/16824FinalProject/models/compute_increase/meta_deploy.prototxt',
                     '/home/rmullapu/16824FinalProject/meta/_iter_30000.caffemodel', caffe.TEST)
...
for n in xrange(0, len(net_list)):
    f_list.append(open('%s_out_val_label.txt'%(net_names[n]), 'w'))
